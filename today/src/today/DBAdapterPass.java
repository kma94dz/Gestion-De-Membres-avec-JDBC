 ...
 */  
public class DBAdapterPass {  
    DBConnectionMgrPass DBCM;  
      
    public DBAdapterPass(){  
        DBCM=new DBConnectionMgrPass();  
    }  
    ...
    public void addImageToDB(String name,String imageName){  
        ...
        String query="INSERT INTO images(MID,PASSPORT) VALUES (?,?)";  
    ...
    public Image getImage(String name){  
        ...
        try{  
            ...
            if(rslt.next()){  
                byte[] imgArr=rslt.getBytes("passport");  
