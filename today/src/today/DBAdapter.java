...
public class DBAdapter {  
    DBConnectionMgrCard DBCM;  
      
    public DBAdapter(){  
        DBCM=new DBConnectionMgrCard();  
    }  
    ...
    public void addImageToDB(String name,String imageName){  
        ...
        String query="INSERT INTO images(MID,CARD) VALUES (?,?)";  
        ...
        try{  
            ...
            byte[] imageFileArr=getByteArrayFromFile(Macron + "/temp/"+imageName);  
    ...
    public Image getImage(String name){  
        ...
        try{  
            ...
            if(rslt.next()){  
                byte[] imgArr=rslt.getBytes("card");  
